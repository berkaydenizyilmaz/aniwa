...
export const EMAIL_CONTENT = {
  VERIFICATION: {
    ...
    EXPIRY_NOTE: 'Bu link ' + (EMAIL_VERIFICATION_TOKEN_EXPIRY / (60 * 1000)) + ' dakika boyunca geçerlidir.',
  ...
  PASSWORD_RESET: {
    ...
    EXPIRY_NOTE: 'Bu link ' + (PASSWORD_RESET_TOKEN_EXPIRY / (60 * 1000)) + ' dakika boyunca geçerlidir.',
    ALTERNATIVE: 'Eğer buton çalışmıyorsa, aşağıdaki linki tarayıcına kopyala:',
